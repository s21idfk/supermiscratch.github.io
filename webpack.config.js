    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                title: 'SupermiScratch - Editor', ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['playground'], template: 'src/playground/index.ejs', filename: 'playground.html',
                title: 'SupermiScratch - Playground', ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['player'], template: 'src/playground/index.ejs', filename: 'index.html',
                title: 'SupermiScratch - A mod of PenguinMod', ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
            ...
            new HtmlWebpackPlugin({
                ...
                title: 'Embedded Project - SupermiScratch', noTheme: true, ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['addon-settings'], template: 'src/playground/simple.ejs', filename: 'addons.html',
                title: 'Addon Settings - SupermiScratch', ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['credits'], template: 'src/playground/simple.ejs', filename: 'credits.html',
                title: 'SupermiScratch, PenguinMod & TurboWarp Credits', noSplash: true, ...htmlWebpackPluginCommon
            }),
